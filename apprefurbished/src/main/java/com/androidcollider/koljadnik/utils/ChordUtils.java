...
public class ChordUtils {
    ...
    private static String[] major = new String[]{"С", "С#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "H"};
    private static String[] minor = new String[]{"Сm", "С#m", "Dm", "D#m", "Em", "Fm", "F#m", "Gm", "G#m", "Am", "A#m", "Hm"};
    private static String[] sept = new String[]{"C7", "C#7", "D7", "D#7", "E7", "F7", "F#7", "G7", "G#7", "A7", "A#7", "H7"};

    private static String[] major_b = new String[]{"С", "Db", "D", "Eb", "E", "F", "Gb", "G", "Ab", "A", "Bb", "B"};
    private static String[] minor_b = new String[]{"Сm", "Dbm", "Dm", "Ebm", "Em", "Fm", "Gbm", "Gm", "Abm", "Am", "Bbm", "Bm"};
    private static String[] sept_b = new String[]{"C7", "Db7", "D7", "Eb7", "E7", "F7", "Gb7", "G7", "Ab7", "A7", "Bb7", "B7"};

    private static String[] major_sus2 = new String[]{"Сsus2", "С#sus2", "Dsus2", "D#sus2", "Esus2", "Fsus2", "F#sus2", "Gsus2", "G#sus2", "Asus2", "A#sus2", "Hsus2"};
    private static String[] minor_sus2 = new String[]{"Сmsus2", "С#msus2", "Dmsus2", "D#msus2", "Emsus2", "Fmsus2", "F#msus2", "Gmsus2", "G#msus2", "Amsus2", "A#msus2", "Hmsus2"};
    ...
    private static String[] major_sus4 = new String[]{"Сsus4", "С#sus4", "Dsus4", "D#sus4", "Esus4", "Fsus4", "F#sus4", "Gsus4", "G#sus4", "Asus4", "A#sus4", "Hsus4"};
    private static String[] minor_sus4 = new String[]{"Сmsus4", "С#msus4", "Dmsus4", "D#msus4", "Emsus4", "Fmsus4", "F#msus4", "Gmsus4", "G#msus4", "Amsus4", "A#msus4", "Hmsus4"};
